...
void ResourcesController::FreeBuffer(BufferResource* resource)
{
    auto bufferIt = buffers_.find(resource);
...
void ResourcesController::FreeImage(ImageResource* resource)
{
    auto imageIt = images_.find(resource);
