...
void VulkanApplicationDelegate::InitImGui()
{
    ...
    char constexpr IMGUI_SET_LAYOUT[] = "imgsl";
    char constexpr IMGUI_PIPELINE[] = "imgpp";
    char constexpr IMGUI_PASS[] = "imgps";
    ...
    renderRoot_->DefineSetLayout(IMGUI_SET_LAYOUT, setLayoutDesc);
    ...
    renderRoot_->DefineRenderPass(IMGUI_PASS, passDesc);



    VKW::GraphicsPipelineDesc pipelineDesc;
    Render::Pass& pass = renderRoot_->FindPass(IMGUI_PASS);
    ...
    pipelineDesc.renderPass_ = pass.VKWRenderPass();
    pipelineDesc.shaderStagesCount_ = 2;
    pipelineDesc.shaderStages_[0] = "vShader";
    pipelineDesc.shaderStages_[1] = "fShader";
